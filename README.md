...
## Specification
[The specification is detailed on the allcontributors.org website](https://allcontributors.org)


## Emoji key
[The Emoji Key ✨ (and Contribution Types) can be found on the allcontributors.org website](https://allcontributors.org/docs/en/emoji-key)
