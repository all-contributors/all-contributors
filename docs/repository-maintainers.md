...
> **Pro tip:** If your project is configured for [the @all-contributors bot 🤖](https://github.com/paras-jain/all-contributors/blob/master/docs/bot/overview.md) simply write a comment on an issue or pull request to recognise their contribution. For example:
>
